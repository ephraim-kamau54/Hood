...
def contactsearch(request):
    ...
    return render(request, 'mtaa_watch/contact_search.html', {'filter': contact_filter})

def businesssearch(request):
    business_list = Business.objects.all()
    business_filter = BusinessFilter(request.GET, queryset=business_list)
    return render(request, 'mtaa_watch/business_search.html', {'filter': business_filter})
...
def neighborhoodsearch(request):
    ...
    return render(request, 'mtaa_watch/neighborhood_search.html', {'filter': neighborhood_filter})